namespace SPGenerator.DAL.Meta
{
    /// <summary>
    /// Columns that are in tabe INFORMATION_SCHEMA.COLUMNS
    /// </summary>
    public static class InformationSchemaCols
    {
        ...
        public const string DOMAIN_CATALOG = "DOMAIN_CATALOG";
        public const string DOMAIN_SCHEMA = "DOMAIN_SCHEMA";
